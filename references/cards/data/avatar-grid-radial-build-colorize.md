...
<!-- name: avatar-grid-radial-build-colorize | category: data | upstream: references/shots/data/avatar-grid-radial-build-colorize.md -->
<!-- source: https://github.com/Vincentwei1021/video-shotcraft/blob/HEAD/references/shots/data/avatar-grid-radial-build-colorize.md -->
<!-- license: Apache-2.0 (© Wei Yihao) | upstream_sha1: 094c44fab856aa8684d4ad0e4e31660144c5cbb4 -->
