<!-- vendored: video-shotcraft -->
<!-- name: chip-grid-single-select-blackout | category: interaction | upstream: references/shots/interaction/chip-grid-single-select-blackout.md -->
<!-- source: https://github.com/Vincentwei1021/video-shotcraft/blob/HEAD/references/shots/interaction/chip-grid-single-select-blackout.md -->
<!-- license: Apache-2.0 (© Wei Yihao) | upstream_sha1: 4f0e30498b756afcf3925a68c4320e61b83947f2 -->
